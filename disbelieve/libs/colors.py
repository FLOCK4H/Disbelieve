...
def iprint(string):
    print(f'{ColorCodes.BRIGHT}{ColorCodes.GREEN}[{ColorCodes.ORANGE}Sniper{ColorCodes.GREEN}]{ColorCodes.RESET}' + ' ' + f'{ColorCodes.WHITE}{ColorCodes.BRIGHT}{string}{ColorCodes.BRIGHT}{ColorCodes.RESET} ')
